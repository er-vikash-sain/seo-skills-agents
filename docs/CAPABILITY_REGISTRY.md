...
| `ai-prompt-research` | `v1.0.0` | Researches conversational prompt query patterns, extracts conversational intent structures, and identifies AI answer engine query variations across package tiers. | `keyword-strategist / english-writer` | `Deterministic Gate / Scorecard` |
...
| `competitor-alternatives` | `v1.0.0` | Strategy and execution for high-commercial intent competitor comparison pages ([Brand] vs [Competitor], Best [Competitor] Alternatives), feature matrix battlecards, and positioning copy. | `keyword-strategist / english-writer` | `Deterministic Gate / Scorecard` |
...
| `content-optimization` | `v1.0.0` | Performs on-page SEO optimization passes on English content drafts, verifies keyword density, heading distribution, and internal link insertions by package tier. | `english-writer / hindi-writer` | `Deterministic Gate / Scorecard` |
...
| `digital-pr` | `v1.0.0` | Formats organic Digital PR outreach briefs, brand mention tracking maps, guest posting specs, and high-authority link building matrices based on client package tier. | `orchestrator` | `Deterministic Gate / Scorecard` |
...
| `humanizer` | `v1.0.0` | Multi-lingual AI writing scrub and humanization protocol. Eliminates AI slop, clichés, overused copula phrasing, and mechanical structures in English and Hindi long-form content. | `english-writer / hindi-writer` | `check_ai_slop.py` |
...
| `keyword-research` | `v1.0.0` | Performs mechanical keyword data extraction, keyword expansion, search volume aggregation, and LSI keyword grouping to support the keyword-strategist subagent. | `keyword-strategist / english-writer` | `Deterministic Gate / Scorecard` |
...
| `programmatic-seo` | `v1.0.0` | Strategy and execution for building SEO-driven pages at scale using structured data and templates. Use for location pages ([keyword] + [city]), directory pages, integration pages, and data-driven landing pages while avoiding thin content penalties. | `keyword-strategist / english-writer` | `Deterministic Gate / Scorecard` |
